...
import {type FormFieldRule, validate} from "../../utils/validation.ts";
...
const InputField: React.FC<InputFieldProps> = ({
    ...
    const validateField = (value: string) => {
        ...
        if (onValidationChange) onValidationChange(!err, name);
        setLocalError(err);
    };
        ...
        <div className={`w-full mb-5 ${otherStyles}`}>
            ...
            <div className="relative">
                <input
                    ...
                    className={`bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10
                        ${displayError ? "border-red-500 focus:ring-red-500 focus:border-red-500" : "border-gray-300"}
